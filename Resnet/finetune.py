...
tf.app.flags.DEFINE_string('tensorboard_root_dir', '/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/resnet/training-yu', 'Root directory to put the training logs and weights')
