...
python finetune.py --num_classes 5 --learning_rate "0.00001" --train_layers "fc"

python finetune.py --num_classes 9 --learning_rate "0.00001" --train_layers "fc,scale5/block3"
