...
tf.app.flags.DEFINE_string('training_file', '/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/data/yu/train.txt', 'Training dataset file')
tf.app.flags.DEFINE_string('val_file', '/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/data/yu/val.txt', 'Validation dataset file')
tf.app.flags.DEFINE_string('tensorboard_root_dir', '/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/vggnet/training-yu', 'Root directory to put the training logs and weights')
