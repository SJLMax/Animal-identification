...
tf.app.flags.DEFINE_string('training_file', '/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/data/all/train2.txt', 'Training dataset file')
tf.app.flags.DEFINE_string('val_file', '/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/data/all/val.txt', 'Validation dataset file')
tf.app.flags.DEFINE_string('tensorboard_root_dir', '/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/alexnet/training-all', 'Root directory to put the training logs and weights')
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        # saver.restore(sess, "/home/ugrad/Shang/animal/tensorflow-cnn-finetune-master/alexnet/training-qita/alexnet_20200808_193540/checkpoint/model_epoch50.ckpt")
